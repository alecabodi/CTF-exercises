...
if __name__ == '__main__':
    ...
    P = ec.point(
        67695524766154990127179050143295912555050197375953539807154652785593269596015,
        25761131395887166914756696972848800389787512966762181205416025056059384511408,
    )

    # test non compressed form
    assert EllipticCurvePoint.from_bytes(ec, P.to_bytes(compression=True)) == P

    # print(P.to_bytes(compression=False).hex())
